...
/**
 * ClassName: Algo_026_1_HashSet_HashMap
 * Package: class26
 * CreateTime: 2024/1/26 15:15
 * Description:
 *
 * @author tongtong zhu
 * @version 1.0
 */
public class Algo_026_1_HashSet_HashMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(map1.containsKey(str2));    // true 也是看值的
        System.out.println(map1.get(str2));    // World,  get(key)得到key所在value
        System.out.println(map1.get("你好") == null);   // true  "你好"这个key不存在，因此返回value是null
        map1.remove("Hello");
        ...
        map2.put(56, 7285);
        map2.put(34, 3671263);    // 新增
        map2.put(17, 716311);
        map2.put(24, 1263161);    // 修改
        ...
        System.out.println(map3.containsKey(s2));     // false  这里找的就是内存地址了
        map3.put(s2, "这是另一个张三");
